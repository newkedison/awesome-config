...
-- theme dir, for relative path of all resource file
dir = awful.util.getdir("config") .. "/themes/default/"
...
theme.tasklist_floating_icon = dir .. "tasklist/floatingw.png"
...
theme.menu_border_color = "#cccccc"
